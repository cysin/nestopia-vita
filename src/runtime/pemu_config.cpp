...
PEMUConfig::PEMUConfig(Renderer *renderer, const std::string &name, int version)
    ...
    joy_grp.addOption({"JOY_LS", KEY_JOY_LS_DEFAULT, JOY_LS})->setFlags(INPUT);
    joy_grp.addOption({"JOY_RS", KEY_JOY_RS_DEFAULT, JOY_RS})->setFlags(INPUT);
...
std::vector<Input::ButtonMapping> PEMUConfig::getKeyboardMapping(int player, bool isGame) {
    ...
    return {
        ...
        {Input::Button::Menu1, getOption(KEY_MENU1, false)->getInteger()},
        {Input::Button::Menu2, getOption(KEY_MENU2, false)->getInteger()}
    };
#else
    return {};
#endif
...
std::vector<Input::ButtonMapping> PEMUConfig::getJoystickMapping(int player, bool isGame) {
    ...
    return {
        ...
        {Input::Button::LS, getOption(JOY_LS, isGame)->getInteger()},
        {Input::Button::RS, getOption(JOY_RS, isGame)->getInteger()},
        {Input::Button::Menu1, getOption(JOY_MENU1, false)->getInteger()},
        {Input::Button::Menu2, getOption(JOY_MENU2, false)->getInteger()}
    };
}
